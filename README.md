...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1288&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-labelled-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-labelled` can be installed with `conda`:
...
```
mamba install r-labelled
```

It is possible to list all of the versions of `r-labelled` available on your platform with `conda`:
...
```
mamba search r-labelled --channel conda-forge
```
...
mamba repoquery search r-labelled --channel conda-forge

# List packages depending on `r-labelled`:
mamba repoquery whoneeds r-labelled --channel conda-forge

# List dependencies of `r-labelled`:
mamba repoquery depends r-labelled --channel conda-forge
```
